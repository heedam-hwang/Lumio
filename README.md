...
Lumio is an iOS reading companion for English book readers. It helps users capture book pages, extract readable text, translate sentences and words into Korean, look up words directly from a dedicated search tab, and save useful vocabulary for later review.

Lumio는 영어 원서를 읽는 사용자를 위한 iOS 읽기 보조 앱입니다. 책 페이지를 촬영하거나 불러와 텍스트를 추출하고, 문장과 단어를 한국어로 번역하며, 전용 검색 탭에서 단어를 바로 조회하고, 중요한 단어를 저장해 다시 복습할 수 있게 도와줍니다.
...
- Look up words directly from the `Word Search` tab and keep recent lookups
...
<table>
  <tr>
    ...
    <td align="center"><strong>Word Search</strong></td>
    <td align="center"><strong>Vocabulary</strong></td>
    
  </tr>
  <tr>
    <td align="center"><img src="./docs/screenshots/books.PNG" alt="Books" width="220"></td>
    <td align="center"><img src="./docs/screenshots/word_search.PNG" alt="Word Search" width="220"></td>
